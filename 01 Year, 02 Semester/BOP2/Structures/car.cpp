...
// b) список автомобилей, которые имеют объем двигателя больше x л., и которые эксплуатируются менее n лет;
// c) список автомобилей указанного года выпуска, которые имеют определенную цифру в серийном номере.
// d) добавить запись в массив
    ...
    do
    {
        ...
        case 3:
        {
            ...
            cout << "Список автомобілів " << inputYear << " року випуску,"
                 << " які мають цифру " << inputSerial << " в серійному номері";
            cout << endl;

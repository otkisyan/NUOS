...
//Дано ціле число A, користуючись бінарними операціями, визначити знак числа (число є від’ємним чи ні).
// Число A навести у 2, 8, 16 та 10 системах числення.
//-------------------------------------------------------------------------------------------------------------//
// 1 ВАРИАНТ:
...
int DecimalToOctal (int number){ //все также как и с двоичной
    int decimal = abs(number);
    int octal[100];
    int i = 0;
    while (decimal > 0) {

// Составить и выполнить программу, которая обрабатывает информацию из файла.
// Указание: реализовать меню с опциями (создать файл, добавить одну
// запись в файл, добавить несколько записей в файл, удалить файл, удалить
// одну запись в файле, удалить несколько записей в файле, вывести содержимое файла
// на экран, вывести содержимое файла на экран согласно заданным критериям).
...
// Создать массив структур. Вывести:
// a) список автомобилей заданной марки;
// b) список автомобилей, которые имеют объем двигателя больше 3 л., и которые
// эксплуатируются менее n лет;
// c) список автомобилей указанного года выпуска, которые имеют определенную
// цифру в серийном номере.
...
int main()
{
    ...
    do
    {
        ...
        case 3:
        {
            ...
            cout << "Список автомобілів " << inputYear << " року випуску,"
                 << " які мають цифри або букви " << inputSerial << " в серійному номері";
            cout << endl;

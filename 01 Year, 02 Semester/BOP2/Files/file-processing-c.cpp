// Мається у файлі таблиця "Успішність студентів за рік". 
// Один рядок таблиці відповідає одному студенту і містить такі відомості: 
// ПІБ студента, номер групи, екзаменаційні оцінки за перший семестр, екзаменаційні оцінки за другий семестр. 
// Впорядкувати рядки  таблиці за номерами груп і знайти студентів, у яких середній бал за другий семестр нижче, ніж за перший. 
// Результати записати в файл. 
...
// ----------------------------- //
//програма, що обробляє текстовий файл

/*
* Написать программу для оценки времени выполнения арифметических операций
* (сложение, вычитание, умножение, деление) для целочисленных операндов и
* для операндов с плавающей точкой.
*/
